    ...
    <div className="bg-black min-h-screen flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full bg-black border border-white/10 rounded-xl p-6 shadow-lg">
        <h1 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
          ...
          <span className="text-sm font-normal px-2 py-0.5 bg-green-500/20 text-green-400 rounded-md">Open Source</span>
        </h1>

        <div className="mb-8">
          <h2 className="text-lg font-medium text-white mb-3">Welcome to CheatSheet AI</h2>
          <p className="text-white/70 text-sm mb-4">
            Your AI-powered assistant for coding problems, MCQs, and web development.
            Capture screenshots and get instant solutions.
          </p>
          <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-4">
            <h3 className="text-white/90 font-medium mb-2">Global Shortcuts</h3>
            <ul className="space-y-2">
              <li className="flex justify-between text-sm">
                <span className="text-white/70">Quick Answer</span>
                <span className="text-white/90">Ctrl+D</span>
              </li>
              <li className="flex justify-between text-sm">
                <span className="text-white/70">Take Screenshot</span>
                <span className="text-white/90">Ctrl+H</span>
              </li>
              <li className="flex justify-between text-sm">
                <span className="text-white/70">Process Screenshots</span>
                <span className="text-white/90">Ctrl+Enter</span>
              </li>
              <li className="flex justify-between text-sm">
                <span className="text-white/70">Toggle Visibility</span>
                <span className="text-white/90">Ctrl+B / Alt+1</span>
              </li>
              <li className="flex justify-between text-sm">
                <span className="text-white/70">Cycle Models</span>
                <span className="text-white/90">Ctrl+\ / Alt+2</span>
              </li>
              <li className="flex justify-between text-sm">
                <span className="text-white/70">Type Clipboard</span>
                <span className="text-white/90">Ctrl+Shift+V</span>
              </li>
              <li className="flex justify-between text-sm">
                <span className="text-white/70">Copy HTML/Code</span>
                <span className="text-white/90">Ctrl+Shift+C</span>
              </li>
              <li className="flex justify-between text-sm">
                <span className="text-white/70">Copy CSS</span>
                <span className="text-white/90">Ctrl+Shift+D</span>
              </li>
              <li className="flex justify-between text-sm">
                <span className="text-white/70">Process Screenshots</span>
